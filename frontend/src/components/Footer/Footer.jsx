        ...
        <div className={footerCss.footer}>
            <div className={footerCss.innerFooter}>
                <div className={footerCss.sec1}>
                    <div className={footerCss.logoBox}>Zomato</div> {/* Updated from Tomato to Zomato */}
                    <div className={footerCss.filters}>
                        ...
                        <div className={footerCss.filterBox}>
                            <span>🌐<span></span> English</span> <span className={footerCss.arrow}>&#709;</span>
                        </div>
                    </div>
                </div>
                <div className={footerCss.sec2}>
                    <div className={[footerCss.box1, footerCss.box].join(' ')}>
                        <div className={footerCss.boxTtl}>ABOUT ZOMATO</div> {/* Updated section title */}
                    ...
                    <div className={[footerCss.box2, footerCss.box].join(' ')}>
                        ...
                        <a href="" className={footerCss.boxOpt}>Zomato</a> {/* Updated link text */}
                    ...
                    <div className={[footerCss.box3, footerCss.box].join(' ')}>
                        ...
                        <a href="" className={footerCss.boxOpt}>Zomato For Work</a> {/* Updated from Tomato to Zomato */}
                    </div>
                ...
                <div className={footerCss.sec3}>
                    By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2022 © Zomato™ Ltd. All rights reserved. {/* Updated from Tomato to Zomato */}
                </div>
            </div>
        </div>
    );
